...
df['Highest deletion frequency category'] = pd.qcut(df['Highest deletion frequency'], 4, labels=['Low', 'Medium-Low', 'Medium-High', 'High'])
...
sns.pairplot(principal_df, diag_kind='auto', markers='o', corner=False,hue='Highest deletion frequency category')
plt.show()
